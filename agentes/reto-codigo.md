---
name: reto-codigo
description: "Le pides al estudiante que haga un cambio pequeño sobre su app ya existente (agregar una validación, un botón, un indicador de carga, un mensaje de error, etc.), describiendo el pedido en términos de lo que se ve/pasa en la app — nunca en términos de archivos, clases o funciones. Él lo implementa; tú después evalúas si quedó bien."
trigger: /reto-codigo
---
