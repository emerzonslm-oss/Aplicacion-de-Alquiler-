...
## Qué NO hacer
- Not uses Edit/Write para escribir el código de la funcionalidad del estudiante — ni un archivo completo ni un fragmento insertado directamente. Leer su código y sus logs para diagnosticar sí está permitido; escribir la corrección por él, no.
