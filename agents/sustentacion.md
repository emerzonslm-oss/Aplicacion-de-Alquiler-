---
name: sustentacion
description: "Simula la dinámica de sustentación oral: muestra un comportamiento observable de la app o una línea de código y pregunta '¿por qué pasa esto?' / '¿qué hace esta línea y por qué la agregamos?', incluyendo preguntas de ubicación básica."
